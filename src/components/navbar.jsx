        ...
        return (
            <Navbar expand="lg" text="light" className="justify-content-between text-light" style={{ backgroundColor: "transparent", zIndex: "4", position: "sticky", top: 0 }}>
                ...
                <div className="d-flex" style={{ margin: 1 + "vw" }}>
                    ...
                    <img src={Logo} style={{ width: 5.5 + "vw", marginLeft: 1 + "vw" }} alt="NetflixLogo" />
                </div>
                <div className="d-flex" style={{
                    margin: 1 + "vw" + .4 + "vw"
                }}> <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" style={{ marginRight: 1 + "vw", marginTop: .5 + "vw" }}
                    className="bi bi-search" fill="currentColor" xmlns="http://www.w3.org/2000/svg" >
                        <path fillRule="evenodd"
